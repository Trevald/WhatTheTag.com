<template>
    <div class="answer text-center bg-teal-900 text-yellow-300 text-2xl py-20 px-8 rounded">
        <p>
            <span v-for="(answer, index) in answers" :key="index" class="text-yellow-400">
                &#x3C;<a :href="getLinkForTag(answer)" class="text-yellow-400 underline" target="wtt-tag">{{answer}}</a>&#x3E;
